...
class airport:
    ...
    def home_page(self):
        ...
        Buttonframe.place(x=0, y=130, width=1280, height=575)

        b1 = Button(Buttonframe, text="Admin",
                    background="black", fg="white", font=("times new roman", 50, "bold"), command=lambda: [lbltitle.destroy(), Buttonframe.destroy(), self.admin_page_2()])
        b1.pack(side=TOP, expand=True, fill=BOTH, pady=5, padx=5)

        # Button 2
        b2 = Button(Buttonframe, text="Staff",
                    background="black", fg="white", font=("times new roman", 50, "bold"), command=lambda: [lbltitle.destroy(), Buttonframe.destroy(), self.rec_page_2()])
        b2.pack(side=TOP, expand=True, fill=BOTH, pady=5, padx=5)

        # Button 3
        b3 = Button(Buttonframe, text="Exit",
                    background="black", fg="white", font=("times new roman", 50, "bold"), command=self.root.destroy)
    ...
    def admin_page_2(self):
        ...
        Dataframe.place(x=0, y=130, width=1280, height=500)
    ...
    def admin_page_3(self):
        ...
        Buttonframe = Frame(self.root, bd=20, relief=RIDGE, bg="cyan")
        Buttonframe.place(x=0, y=130, width=1280, height=650)
...
###----------------Add flight----------------########
    ...
    def Add_Flight(self):
        ...
        Dataframe.place(x=0, y=130, width=1280, height=650)
    ...
    def flight_ticket_2(self):
        ...
        self.ticket_table.place(x=0, y=50, width=1280, height=540)

        conn = mysql.connector.connect(
            host="localhost", username="root", password="root", database="fms2")
    ...
    def rec_page_3(self):
        ...
        Buttonframe = Frame(self.root, bd=20, relief=RIDGE, bg="cyan")
        Buttonframe.place(x=0, y=130, width=1280, height=600)

        b1 = Button(Buttonframe, text="View All Tickets",
                    background="red", fg="white", font=("times new roman", 25, "bold"), command=lambda: [Buttonframe.destroy(), self.rec_showtable()])
        b1.pack(side=TOP, expand=True, fill=BOTH, pady=1, padx=1)

        # Button 2
        b2 = Button(Buttonframe, text="Book a Ticket",
                    background="red", fg="white", font=("times new roman", 25, "bold"), command=lambda: [Buttonframe.destroy(), self.rec_addnew()])
        b2.pack(side=TOP, expand=True, fill=BOTH, pady=1, padx=1)

        # Button 3
        b3 = Button(Buttonframe, text="Find Journey",
                    background="red", fg="white", font=("times new roman", 25, "bold"), command=lambda: [Buttonframe.destroy(),self.find_journey()])
        b3.pack(side=TOP, expand=True, fill=BOTH, pady=1, padx=1)

        # Button 4
        b4 = Button(Buttonframe, text="Log Out",
                    background="green", fg="white", font=("times new roman", 25, "bold"), command=lambda: [Buttonframe.destroy(), self.home_page()])
        b4.pack(side=TOP, expand=True, fill=BOTH, pady=1, padx=1)

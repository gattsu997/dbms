...
drop trigger exp_trig;
 ...
 alter table flight add f_DATE DATE;

 update flight set f_DATE='24-JAN-2021' where airline_id='107';

alter table flight drop f_date;

alter table flight add f_date varchar(20);
 
 update flight set f_DATE='24-JAN-2021' where airline_id='107';
update flight set f_DATE='24-JAN-2021' where airline_id='108';
update flight set f_DATE='24-JAN-2021' where airline_id='109';
update flight set f_DATE='26-JAN-2021' where airline_id='110';

select * from flight where f_date='24-JAN-2021';
select * from flight where f_date='26-JAN-2021';
